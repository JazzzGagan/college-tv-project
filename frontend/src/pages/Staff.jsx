...
const Staff = () => {
  ...
  if (tvMode) {
    ...
    return (
      <div className="w-full h-screen flex items-center justify-center overflow-hidden" style={{ fontFamily: 'Montserrat, sans-serif', backgroundColor: '#001a3d' }}>
        {/* Main Content Area */}
          ...
          >
            ...
            <div className="w-full md:w-2/5 flex-shrink-0">
              ...
              <div className="mb-6">
                ...
                <div className="w-16 h-0.5 mb-2" style={{ backgroundColor: '#ffffff' }}></div>
                <h2 className="text-3xl font-bold text-white">Administration Voice</h2>
              </div>
            ...
            <div className="w-full md:w-3/5 flex">
              <div className="bg-white rounded-lg shadow-md p-8 relative w-full flex flex-col">
                ...
                <div className="pt-2 pl-4 relative z-10">
                  <h2 className="text-2xl font-bold mb-4" style={{ color: '#023F88' }}>
                    Alumni
                  </h2>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    ...
                    <p className="text-gray-600 mt-1">{currentTestimonial.role}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8">
          ...
          {expandedTestimonial === 4 && (
            <div id="testimonial-4" className="flex flex-col md:flex-row-reverse gap-6 items-stretch animate-fade-in" style={{ animation: 'fadeIn 0.8s ease-in 0.7s both' }}>
            {/* Right Side - Image */}
            <div className="w-full md:w-1/3 flex-shrink-0 flex items-center">
              <img
                src={principleImage}
            ...
            <div className="w-full md:w-2/3 flex">
              <div className="bg-white rounded-lg shadow-lg p-8 relative w-full h-full flex flex-col">
                ...
                <div className="pt-2 pl-4 relative z-10">
                  <p className="text-gray-700 leading-relaxed mb-6 text-base">
                    "My experience at Global College International has been transformative. The faculty's dedication to student success and the innovative teaching methods have exceeded my expectations. The college provides an excellent balance between theoretical knowledge and practical application, preparing students for real-world challenges."
                  </p>
          ...
          {expandedTestimonial === 5 && (
            <div id="testimonial-5" className="flex flex-col md:flex-row gap-6 items-stretch animate-fade-in" style={{ animation: 'fadeIn 0.8s ease-in 0.9s both' }}>
            {/* Left Side - Image */}
            <div className="w-full md:w-1/3 flex-shrink-0 flex items-center">
              <img
                src={pranayaImage}
            ...
            <div className="w-full md:w-2/3 flex">
              <div className="bg-white rounded-lg shadow-lg p-8 relative w-full h-full flex flex-col">
                ...
                <div className="pt-2 pl-4 relative z-10">
                  <p className="text-gray-700 leading-relaxed mb-6 text-base">
                    "The supportive environment at GCI has been instrumental in my academic and personal growth. The professors are approachable and genuinely care about student success. The college's commitment to excellence and innovation makes it a standout institution. I'm proud to be an alumnus."
                  </p>
          ...
          {expandedTestimonial === 6 && (
            <div id="testimonial-6" className="flex flex-col md:flex-row-reverse gap-6 items-stretch animate-fade-in" style={{ animation: 'fadeIn 0.8s ease-in 1.1s both' }}>
            {/* Right Side - Image */}
            <div className="w-full md:w-1/3 flex-shrink-0 flex items-center">
              <img
                src={takluImage}
            ...
            <div className="w-full md:w-2/3 flex">
              <div className="bg-white rounded-lg shadow-lg p-8 relative w-full h-full flex flex-col">
                ...
                <div className="pt-2 pl-4 relative z-10">
                  <p className="text-gray-700 leading-relaxed mb-6 text-base">
                    "Global College International offers an exceptional learning experience with state-of-the-art facilities and a curriculum that stays current with industry trends. The hands-on projects and internships provided invaluable real-world experience. The community here is diverse, inclusive, and supportive."
                  </p>

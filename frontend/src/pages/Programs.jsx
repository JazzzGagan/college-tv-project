  ...
  const programs = [
    {
      ...
      description:
        "A comprehensive program designed to provide students with a strong foundation in computer science and information technology. This program combines theoretical knowledge with practical skills, preparing graduates for careers in software development, system administration, and IT management.",
      duration: "4 Years",
    ...
    },
    {
      ...
      description:
        "Created in 2021, this program is young and dynamic. Discover the composition of the team and their skills. The BCA program focuses on application development, software engineering, and computer applications in business environments.",
      duration: "4 Years",
    ...
    },
    {
      ...
      description:
        "Our specialists will help you with pleasure. This program offers tailor-made courses according to your needs and your budget. BBS provides comprehensive business education covering management, finance, marketing, and entrepreneurship.",
      duration: "4 Years",
      credits: "120 Credit Hours",
      image:
    ...
    },
    {
      ...
      description:
        "Find out how we were able to help them and set in place solutions adapted to their needs. The BBM program focuses on management principles, leadership skills, and strategic business thinking to prepare students for managerial roles.",
      duration: "4 Years",
      credits: "120 Credit Hours",
      image:
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {program.features.map((feature, idx) => (
                      ...
                      >
                        <svg
                          className="w-5 h-5 text-[#023F88] flex-shrink-0 mt-0.5"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >

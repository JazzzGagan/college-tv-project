  ...
  return (
    <div className="w-full h-screen bg-gray-100 flex flex-col overflow-hidden" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-gray-200">
        ...
        >
          <div className="flex gap-8 h-full items-center" style={{ minWidth: 'max-content' }}>
            {/* Original Events */}
              {events.map((event, index) => (
                <div
                  key={event.id}
                  className="bg-white overflow-hidden transition-all duration-300 border border-gray-100 group flex-shrink-0 mb-4"
                  style={{ 
                ...
                >
                {/* Event Image */}
                <div className="relative h-72 overflow-hidden bg-gray-200" style={{ borderTopLeftRadius: '16px', borderTopRightRadius: '16px' }}>
                  <img
                    src={event.image}
                    alt={event.title}
                  ...
                  <div className="absolute top-4 left-4">
                    <span
                      className="px-3 py-0.5 rounded-full text-sm font-semibold text-white shadow-sm"
            ...
            {events.map((event, index) => (
              ...
              >
                ...
                {/* Event Content */}
                <div className="p-2 flex flex-col h-[calc(100%-288px)]">
                  <h3 className="text-xl font-bold text-gray-900 mb-1 line-clamp-2 leading-snug">
                    {event.title}
                  </h3>
                  <p className="text-sm text-gray-600 mb-1.5 line-clamp-2 flex-grow">
                    {event.description}
                  </p>
